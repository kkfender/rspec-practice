...
Rails.application.configure do
  ...
  # config/master.key, or an environment key such as config/production.key.
  ...
  # want to see everything, set the level to :debug.
  ...
  # Enable DNS querying. It's required for Action Cable.
  # config.action_cable.dns_reboot = true
